...
void Setup_ePWM7(void){
    ...
    EPwm7Regs.TBPRD = 3255;                         // Period (up/down) 10Khz Clock/4/fpwm LAB PWM
...
void Setup_ePWM8(void){
    ...
    EPwm8Regs.TBPRD = 3255;                         // Period (up/down) Clock/4/fpwm LAB PWM
...
void Setup_ePWM10(void){
    ...
    EPwm10Regs.TBPRD = 3255;                         // Period (up/down) 10Khz Clock/4/fpwm LAB PWM
